  ...
  return (
    <div className="bg-[#FFFCF0] text-[#111] font-sans scroll-smooth">
      ...
      <section id="vctb" className="min-h-screen py-20 px-6">
        ...
        <div
          className="w-[280px] h-[550px] bg-gray-300 rounded-[40px] mx-auto shadow-lg overflow-hidden bg-cover bg-center"
          style={{
            backgroundImage:
              "url('https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/IPhone_14_Pro_Vector.svg/300px-IPhone_14_Pro_Vector.svg.png')",
          }}
        />
      </section>
